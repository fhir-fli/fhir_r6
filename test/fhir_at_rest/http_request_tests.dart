...
void httpRequestTests() {
  group('FhirRequest - READ:', () {
    test('get patient', () {
      ...
      final Map<String, dynamic> requestMap = <String, dynamic>{
        'type': 'GET',
        'url':
            'http://hapi.fhir.org/baseR6/Patient/12345?_format=json&_pretty=false',
    ...
    test('get patient with pretty', () {
      ...
      final Map<String, dynamic> requestMap = <String, dynamic>{
        'type': 'GET',
        'url':
            'http://hapi.fhir.org/baseR6/Patient/12345?_format=json&_pretty=true',
        'headers': <String, String>{
          'test': 'headers',
          'Accept': 'application/fhir+json',
        }
    ...
    test('get patient with pretty and summary true', () {
      ...
      final Map<String, dynamic> requestMap = <String, dynamic>{
        'type': 'GET',
        'url':
            'http://hapi.fhir.org/baseR6/Patient/12345?_format=json&_pretty=true&_summary=true',
        'headers': <String, String>{
          'test': 'headers',
          'Accept': 'application/fhir+json',
        }
    ...
    test('get patient with summary count', () {
      ...
      final Map<String, dynamic> requestMap = <String, dynamic>{
        'type': 'GET',
        'url':
            'http://hapi.fhir.org/baseR6/Patient/12345?_format=json&_pretty=false&_summary=count',
        'headers': <String, String>{
          'test': 'headers',
          'Accept': 'application/fhir+json',
        }
    ...
    test('get patient  with pretty, only want to return name', () {
      ...
      final Map<String, dynamic> requestMap = <String, dynamic>{
        'type': 'GET',
        'url':
            'http://hapi.fhir.org/baseR6/Patient/1227442?_format=json&_pretty=true&_elements=name',
        'headers': <String, String>{
          'test': 'headers',
          'Accept': 'application/fhir+json',
        }
    ...
    test('get patient with pretty, only want to return name and gender', () {
      ...
      final Map<String, dynamic> requestMap = <String, dynamic>{
        'type': 'GET',
        'url':
            'http://hapi.fhir.org/baseR6/Patient/1227442?_format=json&_pretty=true&_elements=name,gender',
        'headers': <String, String>{
          'test': 'headers',
          'Accept': 'application/fhir+json',
        }
  ...
  group('FhirRequest - VREAD:', () {
    test('get patient version', () {
      ...
      final Map<String, dynamic> requestMap = <String, dynamic>{
        'type': 'GET',
        'url':
            'http://hapi.fhir.org/baseR6/Patient/12345/_history/6789?_format=json&_pretty=false',
        'headers': <String, String>{
          'test': 'headers',
          'Accept': 'application/fhir+json',
        }
    ...
    test('get patient version with pretty', () {
      ...
      final Map<String, dynamic> requestMap = <String, dynamic>{
        'type': 'GET',
        'url':
            'http://hapi.fhir.org/baseR6/Patient/12345/_history/6789?_format=json&_pretty=true',
        'headers': <String, String>{
          'test': 'headers',
          'Accept': 'application/fhir+json',
        }
    ...
    test('get patient version with pretty and summary true', () {
      ...
      final Map<String, dynamic> requestMap = <String, dynamic>{
        'type': 'GET',
        'url':
            'http://hapi.fhir.org/baseR6/Patient/12345/_history/6789?_format=json&_pretty=true&_summary=true',
        'headers': <String, String>{
          'test': 'headers',
          'Accept': 'application/fhir+json',
        }
    ...
    test('get patient version with summary count', () {
      ...
      final Map<String, dynamic> requestMap = <String, dynamic>{
        'type': 'GET',
        'url':
            'http://hapi.fhir.org/baseR6/Patient/12345/_history/6789?_format=json&_pretty=false&_summary=count',
        'headers': <String, String>{
          'test': 'headers',
          'Accept': 'application/fhir+json',
        }
  ...
  group('FhirRequest - TRANSACTION:', () {
    test('transaction/batch', () {
      ...
      final Map<String, dynamic> requestMap = <String, dynamic>{
        'type': 'POST',
        'url': 'http://hapi.fhir.org/baseR6?_format=json&_pretty=false',
        'headers': <String, String>{
          'test': 'headers',
          'Accept': 'application/fhir+json',
  ...
  group('FhirRequest - HISTORY:', () {
    test('observation history by type and id', () {
      final FhirRequest request = FhirRequest.history(
        base: Uri.parse('http://hapi.fhir.org/baseR6'),
        type: R6ResourceType.Observation,
        id: '12345',
        pretty: false,
      );
      final FhirHttpRequest fhirHttpRequest = request
      ...
      final Map<String, dynamic> requestMap = <String, dynamic>{
        'type': 'GET',
        'url':
            'http://hapi.fhir.org/baseR6/Observation/12345/_history?_format=json&_pretty=false',
        'headers': <String, String>{
          'test': 'headers',
          'Accept': 'application/fhir+json',
        }
    ...
    test('observation history by type', () {
      ...
      final Map<String, dynamic> requestMap = <String, dynamic>{
        'type': 'GET',
        'url':
            'http://hapi.fhir.org/baseR6/Observation/_history?_format=json&_pretty=false',
        'headers': <String, String>{
          'test': 'headers',
          'Accept': 'application/fhir+json',
        }
    ...
    test('history for everything', () {
      ...
      final Map<String, dynamic> requestMap = <String, dynamic>{
        'type': 'GET',
        'url':
            'http://hapi.fhir.org/baseR6/_history?_format=json&_pretty=false',
        'headers': <String, String>{
          'test': 'headers',
          'Accept': 'application/fhir+json',
        }
    ...
    test('history resource by type and id, count of 10, after a specified date',
      ...
      final Map<String, dynamic> requestMap = <String, dynamic>{
        'type': 'GET',
        'url': 'http://hapi.fhir.org/baseR6/Observation/12345/_history'
    ...
    test(
      ...
      final Map<String, dynamic> requestMap = <String, dynamic>{
        'type': 'GET',
        'url': 'http://hapi.fhir.org/baseR6/_history?_format=json&_pretty=false'
  ...
  group('FhirRequest - CREATE:', () {
    test('create patient', () {
      ...
      final Map<String, dynamic> requestMap = <String, dynamic>{
        'type': 'POST',
        'url': 'http://hapi.fhir.org/baseR6/Patient?_format=json&_pretty=false',
        'headers': <String, String>{
          'test': 'headers',
          'Accept': 'application/fhir+json',
          'Content-Type': 'application/fhir+json',
  ...
  group('FhirRequest - CAPABILITIES:', () {
    test('capabilities with mode normative', () {
      ...
      final Map<String, dynamic> requestMap = <String, dynamic>{
        'type': 'GET',
        'url': 'http://hapi.fhir.org/baseR6/metadata'
  ...
  group('FhirRequest - OPERATION:', () {
    test(r'$everything operation', () {
      ...
      final Map<String, dynamic> requestMap = <String, dynamic>{
        'type': 'GET',
        'url': r'http://hapi.fhir.org/baseR6/$everything'
    ...
    test(r'$everything operation for Patient 744742', () {
      ...
      final Map<String, dynamic> requestMap = <String, dynamic>{
        'type': 'GET',
        'url': r'http://hapi.fhir.org/baseR6/Patient/744742/$everything?_format'
  ...
  group('FhirRequest - SEARCH:', () {
    test('patient id search', () {
      ...
      final Map<String, dynamic> requestMap = <String, dynamic>{
        'type': 'GET',
        'url':
            'http://hapi.fhir.org/baseR6/Patient?_format=json&_pretty=false&_id=12345',
        'headers': <String, String>{
          'test': 'headers',
          'Accept': 'application/fhir+json',
        }
    ...
    test('patient id search using post', () {
      ...
      final Map<String, dynamic> requestMap = <String, dynamic>{
        'type': 'GET',
        'url':
            'http://hapi.fhir.org/baseR6/Patient/_search?_format=json&_pretty=false',
        'headers': <String, String>{
          'test': 'headers',
          'Accept': 'application/fhir+json',
        }
    ...
    test('observation time search', () {
      ...
      final Map<String, dynamic> requestMap = <String, dynamic>{
        'type': 'GET',
        'url': 'http://hapi.fhir.org/baseR6/Observation'
    ...
    test('condition search, code parameter (_tag)', () {
      ...
      final Map<String, dynamic> requestMap = <String, dynamic>{
        'type': 'GET',
        'url': 'http://hapi.fhir.org/baseR6/Condition'
    ...
    test('diagnostic report rearch, uri parameter (_profile)', () {
      ...
      final FhirRequest request = FhirRequest.search(
        base: Uri.parse('http://hapi.fhir.org/baseR6'),
        type: R6ResourceType.DiagnosticReport,
        parameters: parameters,
        pretty: false,
      );
      final FhirHttpRequest fhirHttpRequest = request
      ...
      final Map<String, dynamic> requestMap = <String, dynamic>{
        'type': 'GET',
        'url': 'http://hapi.fhir.org/baseR6/DiagnosticReport'
    ...
    test('patient search if gender present', () {
      ...
      final Map<String, dynamic> requestMap = <String, dynamic>{
        'type': 'GET',
        'url': 'http://hapi.fhir.org/baseR6/Patient'
    ...
    test('observation search "le"', () {
      ...
      final Map<String, dynamic> requestMap = <String, dynamic>{
        'type': 'GET',
        'url':
            'http://hapi.fhir.org/baseR6/Observation?_format=json&_pretty=false&_lastUpdated=le2010-10-01',
        'headers': <String, String>{
          'test': 'headers',
          'Accept': 'application/fhir+json',
        }
    ...
    test('risk assessment search, probability > 0.8', () {
      ...
      final FhirRequest request = FhirRequest.search(
        base: Uri.parse('http://hapi.fhir.org/baseR6'),
        type: R6ResourceType.RiskAssessment,
        parameters: parameters,
        pretty: false,
      );
      final FhirHttpRequest fhirHttpRequest = request
      ...
      final Map<String, dynamic> requestMap = <String, dynamic>{
        'type': 'GET',
        'url':
            'http://hapi.fhir.org/baseR6/RiskAssessment?_format=json&_pretty=false&probability=gt0.8',
        'headers': <String, String>{
          'test': 'headers',
          'Accept': 'application/fhir+json',
        }
    ...
    test('composition search section code', () {
      ...
      final FhirRequest request = FhirRequest.search(
        base: Uri.parse('http://hapi.fhir.org/baseR6'),
        type: R6ResourceType.Composition,
        parameters: parameters,
        pretty: false,
      );
      final FhirHttpRequest fhirHttpRequest = request
      ...
      final Map<String, dynamic> requestMap = <String, dynamic>{
        'type': 'GET',
        'url': 'http://hapi.fhir.org/baseR6/Composition'
