...
Future<void> fhirUriTest() async {
  ...
  group('FHIR URI - READ:', () {
    test('get patient', () async {
      ...
      expect(
        request.uri(),
        'http://hapi.fhir.org/baseR6/Patient/12345?_format=$mimeType&_pretty=false',
      );
    });
    ...
    test('get patient with pretty', () async {
      ...
      expect(
        request.uri(),
        'http://hapi.fhir.org/baseR6/Patient/12345?_format=$mimeType&_pretty=true',
      );
    });
    ...
    test('get patient with pretty and summary true', () async {
      ...
      expect(
        request.uri(),
        'http://hapi.fhir.org/baseR6/Patient/12345?_format=$mimeType&_pretty=true&_summary=true',
      );
    });
    ...
    test('get patient with summary count', () async {
      ...
      expect(
        request.uri(),
        'http://hapi.fhir.org/baseR6/Patient/12345?_format=$mimeType&_pretty=false&_summary=count',
      );
    });
    ...
    test('get patient  with pretty, only want to return name', () async {
      ...
      expect(
        request.uri(),
        'http://hapi.fhir.org/baseR6/Patient/1227442?_format=$mimeType&_pretty=true&_elements=name',
      );
    });
    ...
    test('get patient with pretty, only want to return name and gender',
      ...
      expect(
        request.uri(),
        'http://hapi.fhir.org/baseR6/Patient/1227442?_format=$mimeType&_pretty=true&_elements=name,gender',
      );
    });
  ...
  group('FHIR URI - VREAD:', () {
    test('get patient version', () async {
      ...
      expect(
        request.uri(),
        'http://hapi.fhir.org/baseR6/Patient/12345/_history/6789?_format=$mimeType&_pretty=false',
      );
    });
    ...
    test('get patient version with pretty', () async {
      ...
      expect(
        request.uri(),
        'http://hapi.fhir.org/baseR6/Patient/12345/_history/6789?_format=$mimeType&_pretty=true',
      );
    });
    ...
    test('get patient version with pretty and summary true', () async {
      ...
      expect(
        request.uri(),
        'http://hapi.fhir.org/baseR6/Patient/12345/_history/6789?_format=$mimeType&_pretty=true&_summary=true',
      );
    });
    ...
    test('get patient version with summary count', () async {
      ...
      expect(
        request.uri(),
        'http://hapi.fhir.org/baseR6/Patient/12345/_history/6789?_format=$mimeType&_pretty=false&_summary=count',
      );
    });
  ...
  group('FHIR URI - TRANSACTION:', () {
    test('transaction/batch', () async {
      ...
      expect(
        request.uri(),
        'http://hapi.fhir.org/baseR6?_format=$mimeType&_pretty=false',
      );
    });
  ...
  group('FHIR URI - HISTORY:', () {
    test('observation history by type and id', () async {
      ...
      expect(
        request.uri(),
        'http://hapi.fhir.org/baseR6/Observation/12345/_history?_format=$mimeType&_pretty=false',
      );
    });
    ...
    test('observation history by type', () async {
      ...
      expect(
        request.uri(),
        'http://hapi.fhir.org/baseR6/Observation/_history?_format=$mimeType&_pretty=false',
      );
    });
    ...
    test('history for everything', () async {
      ...
      expect(
        request.uri(),
        'http://hapi.fhir.org/baseR6/_history?_format=$mimeType&_pretty=false',
      );
    });
    ...
    test('history resource by type and id, count of 10, after a specified date',
      ...
      expect(
        ...
        'http://hapi.fhir.org/baseR6/Observation/12345/_history'
  ...
  group('FHIR URI - CREATE:', () {
    test('create patient', () async {
      ...
      expect(
        request.uri(),
        'http://hapi.fhir.org/baseR6/Patient?_format=$mimeType&_pretty=false',
      );
    });
  ...
  group('FHIR URI - CAPABILITIES:', () {
    test('capabilities with mode normative', () async {
      ...
      expect(
        request.uri(),
        'http://hapi.fhir.org/baseR6/metadata'
  ...
  group('FHIR URI - OPERATION:', () {
    test(r'$everything operation', () async {
      ...
      expect(
        request.uri(parameters: parameters),
        r'http://hapi.fhir.org/baseR6/$everything'
    ...
    test(r'$everything operation for Patient 744742', () async {
      ...
      expect(
        request.uri(parameters: parameters),
        r'http://hapi.fhir.org/baseR6/Patient/744742/$everything?_format'
  ...
  group('FHIR URI - SEARCH:', () {
    test('patient id search', () async {
      ...
      expect(
        request.uri(parameters: parameters),
        'http://hapi.fhir.org/baseR6/Patient?_format=$mimeType&_pretty=false&_id=12345',
      );
    });
    ...
    test('patient id search using post', () async {
      ...
      expect(
        request.uri(),
        'http://hapi.fhir.org/baseR6/Patient/_search?_format=$mimeType&_pretty=false',
      );
    });
    ...
    test('observation time search', () async {
      ...
      expect(
        request.uri(parameters: parameters),
        'http://hapi.fhir.org/baseR6/Observation'
    ...
    test('condition search, code parameter (_tag)', () async {
      ...
      expect(
        request.uri(parameters: parameters),
        'http://hapi.fhir.org/baseR6/Condition'
    ...
    test('diagnostic report rearch, uri parameter (_profile)', () async {
      ...
      expect(
        request.uri(parameters: parameters),
        'http://hapi.fhir.org/baseR6/DiagnosticReport'
    ...
    test('patient search if gender present', () async {
      ...
      expect(
        request.uri(parameters: parameters),
        'http://hapi.fhir.org/baseR6/Patient'
    ...
    test('observation search "le"', () async {
      ...
      expect(
        request.uri(parameters: parameters),
        'http://hapi.fhir.org/baseR6/Observation?_format=$mimeType&_pretty=false&_lastUpdated=le2010-10-01',
      );
    });
    ...
    test('risk assessment search, probability > 0.8', () async {
      ...
      expect(
        request.uri(parameters: parameters),
        'http://hapi.fhir.org/baseR6/RiskAssessment?_format=$mimeType&_pretty=false&probability=gt0.8',
      );
    });
    ...
    test('composition search section code', () async {
      ...
      expect(
        request.uri(parameters: parameters),
        'http://hapi.fhir.org/baseR6/Composition'
