      ...
      test('transaction/batch', () async {
        ...
        const OperationOutcome mockedOutcome = OperationOutcome(
          issue: <OperationOutcomeIssue>[
            OperationOutcomeIssue(
              details: CodeableConcept(
                text: 'http://hapi.fhir.org/baseR6?_format=json&_pretty=false',
              ),
            ),
          ],
        );
        ...
        expect(
          response?.issue.first.details?.text,
          'http://hapi.fhir.org/baseR6?_format=json&_pretty=false',
        );
      });
        ...
        const OperationOutcome mockedOutcome = OperationOutcome(
          issue: <OperationOutcomeIssue>[
            OperationOutcomeIssue(
              details: CodeableConcept(
                text:
                    'http://hapi.fhir.org/baseR6/Observation/12345/_history?_format=json&_pretty=false&_count=10&_since=2020-10-08T16:58:07.241117Z',
              ),
            ),
          ],
        );
        ...
        const OperationOutcome mockedOutcome = OperationOutcome(
          issue: <OperationOutcomeIssue>[
            OperationOutcomeIssue(
              details: CodeableConcept(
                text:
                    'http://hapi.fhir.org/baseR6/_history?_format=json&_pretty=false&_list=List/12345&_count=10&_since=2020-10-08',
              ),
            ),
          ],
        );
        ...
        const OperationOutcome mockedOutcome = OperationOutcome(
          issue: <OperationOutcomeIssue>[
            OperationOutcomeIssue(
              details: CodeableConcept(
                text:
                    'http://hapi.fhir.org/baseR6/Patient?_format=json&_pretty=false',
              ),
            ),
          ],
        );
        ...
        const OperationOutcome mockedOutcome = OperationOutcome(
          issue: <OperationOutcomeIssue>[
            OperationOutcomeIssue(
              details: CodeableConcept(
                text:
                    'http://hapi.fhir.org/baseR6/metadata?_format=json&_pretty=false',
              ),
            ),
          ],
        );
        ...
        const OperationOutcome mockedOutcome = OperationOutcome(
          issue: <OperationOutcomeIssue>[
            OperationOutcomeIssue(
              details: CodeableConcept(
                text:
                    r'http://hapi.fhir.org/baseR6/$everything?_format=json&_pretty=false&start=2020-01-01&end=2020-08-01',
              ),
            ),
          ],
        );
        ...
        const OperationOutcome mockedOutcome = OperationOutcome(
          issue: <OperationOutcomeIssue>[
            OperationOutcomeIssue(
              details: CodeableConcept(
                text:
                    r'http://hapi.fhir.org/baseR6/Patient/744742/$everything?_format=json&_pretty=false&start=2020-01-01&end=2020-08-01',
              ),
            ),
          ],
        );
      ...
      const OperationOutcome mockedOutcome = OperationOutcome(
        issue: <OperationOutcomeIssue>[
          OperationOutcomeIssue(
            details: CodeableConcept(
              text:
                  'http://hapi.fhir.org/baseR6/Observation?_format=json&_pretty=false&_lastUpdated=gt2010-10-01',
            ),
          ),
        ],
      );
      ...
      const OperationOutcome mockedOutcome = OperationOutcome(
        issue: <OperationOutcomeIssue>[
          OperationOutcomeIssue(
            details: CodeableConcept(
              text:
                  'http://hapi.fhir.org/baseR6/Condition?_format=json&_pretty=false&_tag=http://acme.org/codes|needs-review',
            ),
          ),
        ],
      );
      ...
      const OperationOutcome mockedOutcome = OperationOutcome(
        issue: <OperationOutcomeIssue>[
          OperationOutcomeIssue(
            details: CodeableConcept(
              text:
                  'http://hapi.fhir.org/baseR6/DiagnosticReport?_format=json&_pretty=false&_profile=http://acme.org/codes',
            ),
          ),
        ],
      );
      ...
      const OperationOutcome mockedOutcome = OperationOutcome(
        issue: <OperationOutcomeIssue>[
          OperationOutcomeIssue(
            details: CodeableConcept(
              text:
                  'http://hapi.fhir.org/baseR6/Patient?_format=json&_pretty=false&gender:missing=true',
            ),
          ),
        ],
      );
      ...
      const OperationOutcome mockedOutcome = OperationOutcome(
        issue: <OperationOutcomeIssue>[
          OperationOutcomeIssue(
            details: CodeableConcept(
              text:
                  'http://hapi.fhir.org/baseR6/Patient?_format=json&_pretty=false&gender:missing=false',
            ),
          ),
        ],
      );
      ...
      const OperationOutcome mockedOutcome = OperationOutcome(
        issue: <OperationOutcomeIssue>[
          OperationOutcomeIssue(
            details: CodeableConcept(
              text:
                  'http://hapi.fhir.org/baseR6/Patient?_format=json&_pretty=false&_text:exact=Stark',
            ),
          ),
        ],
      );
      ...
      const OperationOutcome mockedOutcome = OperationOutcome(
        issue: <OperationOutcomeIssue>[
          OperationOutcomeIssue(
            details: CodeableConcept(
              text:
                  'http://hapi.fhir.org/baseR6/Patient?_format=json&_pretty=false&_text:contains=Stark',
            ),
          ),
        ],
      );
      ...
      const OperationOutcome mockedOutcome = OperationOutcome(
        issue: <OperationOutcomeIssue>[
          OperationOutcomeIssue(
            details: CodeableConcept(
              text:
                  'http://hapi.fhir.org/baseR6/Patient?_format=json&_pretty=false&_text:contains=Stark&_text:exact=Stark',
            ),
          ),
        ],
      );
      ...
      const OperationOutcome mockedOutcome = OperationOutcome(
        issue: <OperationOutcomeIssue>[
          OperationOutcomeIssue(
            details: CodeableConcept(
              text:
                  'http://hapi.fhir.org/baseR6/Patient?_format=json&_pretty=false&birthdate=ge2010-01-01&birthdate=le2011-12-31',
            ),
          ),
        ],
      );
      ...
      const OperationOutcome mockedOutcome = OperationOutcome(
        issue: <OperationOutcomeIssue>[
          OperationOutcomeIssue(
            details: CodeableConcept(
              text:
                  'http://hapi.fhir.org/baseR6/Patient?_format=json&_pretty=false&given=eve&given:contains=eve&given:exact=eve',
            ),
          ),
        ],
      );
      ...
      const OperationOutcome mockedOutcome = OperationOutcome(
        issue: <OperationOutcomeIssue>[
          OperationOutcomeIssue(
            details: CodeableConcept(
              text:
                  'http://hapi.fhir.org/baseR6/Patient?_format=json&_pretty=false&identifier=http://acme.org/patient|2345',
            ),
          ),
        ],
      );
      ...
      const OperationOutcome mockedOutcome = OperationOutcome(
        issue: <OperationOutcomeIssue>[
          OperationOutcomeIssue(
            details: CodeableConcept(
              text:
                  'http://hapi.fhir.org/baseR6/Composition?_format=json&_pretty=false&section:not=48765-2',
            ),
          ),
        ],
      );
      ...
      const OperationOutcome mockedOutcome = OperationOutcome(
        issue: <OperationOutcomeIssue>[
          OperationOutcomeIssue(
            details: CodeableConcept(
              text:
                  'http://hapi.fhir.org/baseR6/Condition?_format=json&_pretty=false&code:in=http://snomed.info/sct?fhir_vs=isa/126851005',
            ),
          ),
        ],
      );
      ...
      const OperationOutcome mockedOutcome = OperationOutcome(
        issue: <OperationOutcomeIssue>[
          OperationOutcomeIssue(
            details: CodeableConcept(
              text:
                  'http://hapi.fhir.org/baseR6/Condition?_format=json&_pretty=false&code:in=http://snomed.info/sct|126851005',
            ),
          ),
        ],
      );
      ...
      const OperationOutcome mockedOutcome = OperationOutcome(
        issue: <OperationOutcomeIssue>[
          OperationOutcomeIssue(
            details: CodeableConcept(
              text:
                  'http://hapi.fhir.org/baseR6/Patient?_format=json&_pretty=false&identifier:of-type=http://terminology.hl7.org/CodeSystem/v2-0203|MR|446053',
            ),
          ),
        ],
      );
      ...
      const OperationOutcome mockedOutcome = OperationOutcome(
        issue: <OperationOutcomeIssue>[
          OperationOutcomeIssue(
            details: CodeableConcept(
              text:
                  'http://hapi.fhir.org/baseR6/Observation?_format=json&_pretty=false&value-quantity=ap5.4|http://unitsofmeasure.org|mg',
            ),
          ),
        ],
      );
      ...
      const OperationOutcome mockedOutcome = OperationOutcome(
        issue: <OperationOutcomeIssue>[
          OperationOutcomeIssue(
            details: CodeableConcept(
              text:
                  'http://hapi.fhir.org/baseR6/Observation?_format=json&_pretty=false&value-quantity=5.4|http://unitsofmeasure.org|mg',
            ),
          ),
        ],
      );
      ...
      const OperationOutcome mockedOutcome = OperationOutcome(
        issue: <OperationOutcomeIssue>[
          OperationOutcomeIssue(
            details: CodeableConcept(
              text:
                  'http://hapi.fhir.org/baseR6/Observation?_format=json&_pretty=false&value-quantity=0.0054|http://unitsofmeasure.org|g',
            ),
          ),
        ],
      );
      ...
      const OperationOutcome mockedOutcome = OperationOutcome(
        issue: <OperationOutcomeIssue>[
          OperationOutcomeIssue(
            details: CodeableConcept(
              text:
                  'http://hapi.fhir.org/baseR6/Observation?_format=json&_pretty=false&subject=Patient/123',
            ),
          ),
        ],
      );
