...
class NutritionIntake extends DomainResource {
  ...
  bool equalsDeep(FhirBase? o) {
    ...
    if (!FhirBase.listEquals<NutritionIntakeNutritionItem>(
      nutritionItem,
      o.nutritionItem,
    )) {
      return false;
...
class NutritionIntakeNutritionItem extends BackboneElement {
  ...
  bool equalsDeep(FhirBase? o) {
    ...
    if (!FhirBase.listEquals<NutritionIntakeNotConsumedItem>(
      notConsumedItem,
      o.notConsumedItem,
    )) {
      return false;
...
class NutritionIntakeConsumedItem extends BackboneElement {
  ...
  bool equalsDeep(FhirBase? o) {
    ...
    if (!FhirBase.listEquals<NutritionIntakeTotalIntake>(
      totalIntake,
      o.totalIntake,
    )) {
      return false;
