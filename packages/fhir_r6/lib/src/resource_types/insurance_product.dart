...
class InsuranceProduct extends DomainResource {
  ...
  bool equalsDeep(FhirBase? o) {
    ...
    if (!FhirBase.listEquals<InsuranceProductCoverage>(
      coverage,
      o.coverage,
    )) {
      return false;
    }
    if (!FhirBase.listEquals<InsuranceProductRelated>(
      related,
      o.related,
    )) {
      return false;
...
class InsuranceProductCoverage extends BackboneElement {
  ...
  bool equalsDeep(FhirBase? o) {
    ...
    if (!FhirBase.listEquals<InsuranceProductBenefit>(
      benefit,
      o.benefit,
    )) {
      return false;
...
class InsuranceProductBenefit extends BackboneElement {
  ...
  bool equalsDeep(FhirBase? o) {
    ...
    if (!FhirBase.listEquals<InsuranceProductLimit>(
      limit,
      o.limit,
    )) {
      return false;
