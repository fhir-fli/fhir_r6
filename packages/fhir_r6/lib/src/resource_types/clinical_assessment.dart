...
/// score.
class ClinicalAssessment extends DomainResource {
  ...
  const ClinicalAssessment({
    ...
    this.encounter,
    EffectiveXClinicalAssessment? effectiveX,
  ...
  factory ClinicalAssessment.fromJson(
    ...
    return ClinicalAssessment(
      ...
      effectiveX: JsonParser.parsePolymorphic<EffectiveXClinicalAssessment>(
        json,
        {
      ...
      finding: (json['finding'] as List<dynamic>?)
          ?.map<ClinicalAssessmentFinding>(
            (v) => ClinicalAssessmentFinding.fromJson(
              {...v as Map<String, dynamic>},
            ),
          )
          .toList(),
  ...
  /// Deserialize [ClinicalAssessment]
  /// from a [String] or [YamlMap] object
  factory ClinicalAssessment.fromYaml(
    dynamic yaml,
  ) {
    if (yaml is String) {
  ...
  factory ClinicalAssessment.fromJsonString(
    String source,
  ) {
  ...
  final EffectiveXClinicalAssessment? effectiveX;
  ...
  final List<ClinicalAssessmentFinding>? finding;
  ...
  @override
  ClinicalAssessment clone() => copyWith();

  /// Copy function for [ClinicalAssessment]
  /// Returns a copy of the current instance with the provided fields modified.
  /// If a field is not provided, it will retain its original value.
  /// If a null is provided, this will clearn the field, unless the
  /// field is required, in which case it will keep its current value.
  @override
  $ClinicalAssessmentCopyWith<ClinicalAssessment> get copyWith =>
      _$ClinicalAssessmentCopyWithImpl<ClinicalAssessment>(
        this,
        (value) => value,
      );
  ...
  bool equalsDeep(FhirBase? o) {
    ...
    if (!FhirBase.listEquals<ClinicalAssessmentFinding>(
      finding,
      o.finding,
    )) {
      return false;
...
/// Specific findings or diagnoses that were considered likely or relevant
/// to ongoing treatment.
class ClinicalAssessmentFinding extends BackboneElement {
  /// Primary constructor for
  /// [ClinicalAssessmentFinding]

  const ClinicalAssessmentFinding({
    super.id,
    super.extension_,
    super.modifierExtension,
    this.item,
  ...
  /// Factory constructor that accepts [Map<String, dynamic>] as an argument
  factory ClinicalAssessmentFinding.fromJson(
    Map<String, dynamic> json,
  ) {
  ...
  /// Deserialize [ClinicalAssessmentFinding]
  /// from a [String] or [YamlMap] object
  factory ClinicalAssessmentFinding.fromYaml(
    dynamic yaml,
  ) {
    if (yaml is String) {
      return ClinicalAssessmentFinding.fromJson(
        yamlToJson(yaml),
      );
    } else if (yaml is YamlMap) {
      return ClinicalAssessmentFinding.fromJson(
  ...
  /// Convenience method to avoid the json Encoding/Decoding normally required
  /// to get data from a [String]
  factory ClinicalAssessmentFinding.fromJsonString(
    String source,
  ) {
    final dynamic json = jsonDecode(source);
    if (json is Map<String, dynamic>) {
      return ClinicalAssessmentFinding.fromJson(json);
    } else {
      throw FormatException('FormatException: You passed $json '
          'This does not properly decode to a Map<String, dynamic>.');
    }
  ...
  @override
  ClinicalAssessmentFinding clone() => copyWith();

  /// Copy function for [ClinicalAssessmentFinding]
  /// Returns a copy of the current instance with the provided fields modified.
  /// If a field is not provided, it will retain its original value.
  /// If a null is provided, this will clearn the field, unless the
  /// field is required, in which case it will keep its current value.
  @override
  $ClinicalAssessmentFindingCopyWith<ClinicalAssessmentFinding> get copyWith =>
      _$ClinicalAssessmentFindingCopyWithImpl<ClinicalAssessmentFinding>(
        this,
        (value) => value,
      );
  ...
  @override
  bool equalsDeep(FhirBase? o) {
    if (o is! ClinicalAssessmentFinding) {
      return false;
    }
    if (identical(this, o)) return true;
    if (runtimeType != o.runtimeType) return false;
