...
abstract class $ClinicalAssessmentCopyWith<T>
  ...
  T call({
    ...
    List<ClinicalAssessmentFinding>? finding,
...
class _$ClinicalAssessmentCopyWithImpl<T>
    implements $ClinicalAssessmentCopyWith<T> {
  final ClinicalAssessment _value;
  final T Function(ClinicalAssessment) _then;

  _$ClinicalAssessmentCopyWithImpl(this._value, this._then);
    ...
    return _then(
      ClinicalAssessment(
        ...
        effectiveX: identical(effectiveX, fhirSentinel)
            ? _value.effectiveX
            : effectiveX as EffectiveXClinicalAssessment?,
        date:
        ...
        finding: identical(finding, fhirSentinel)
            ? _value.finding
            : finding as List<ClinicalAssessmentFinding>?,
...
extension ClinicalAssessmentCopyWithExtension on ClinicalAssessment {
...
abstract class $ClinicalAssessmentFindingCopyWith<T>
...
class _$ClinicalAssessmentFindingCopyWithImpl<T>
    implements $ClinicalAssessmentFindingCopyWith<T> {
  final ClinicalAssessmentFinding _value;
  final T Function(ClinicalAssessmentFinding) _then;

  _$ClinicalAssessmentFindingCopyWithImpl(this._value, this._then);
...
extension ClinicalAssessmentFindingCopyWithExtension
    on ClinicalAssessmentFinding {
