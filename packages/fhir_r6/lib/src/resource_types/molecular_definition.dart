...
class MolecularDefinition extends DomainResource {
  ...
  bool equalsDeep(FhirBase? o) {
    ...
    if (!listEquals<MolecularDefinitionLocation>(
      location,
      o.location,
    )) {
      return false;
    }
    if (!listEquals<MolecularDefinitionRepresentation>(
      representation,
      o.representation,
    )) {
      return false;
...
class MolecularDefinitionConcatenated extends BackboneElement {
  ...
  bool equalsDeep(FhirBase? o) {
    ...
    if (!listEquals<MolecularDefinitionSequenceElement>(
      sequenceElement,
      o.sequenceElement,
    )) {
      return false;
...
class MolecularDefinitionRelative extends BackboneElement {
  ...
  bool equalsDeep(FhirBase? o) {
    ...
    if (!listEquals<MolecularDefinitionEdit>(
      edit,
      o.edit,
    )) {
      return false;
