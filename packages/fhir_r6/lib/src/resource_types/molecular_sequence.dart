...
class MolecularSequence extends DomainResource {
  ...
  bool equalsDeep(FhirBase? o) {
    ...
    if (!FhirBase.listEquals<MolecularSequenceLiteral>(
      literal,
      o.literal,
    )) {
      return false;
    ...
    if (!FhirBase.listEquals<MolecularSequenceExtracted>(
      extracted,
      o.extracted,
    )) {
      return false;
    }
    if (!FhirBase.listEquals<MolecularSequenceRepeated>(
      repeated,
      o.repeated,
    )) {
      return false;
...
class MolecularSequenceConcatenated extends BackboneElement {
  ...
  bool equalsDeep(FhirBase? o) {
    ...
    if (!FhirBase.listEquals<MolecularSequenceSequenceElement>(
      sequenceElement,
      o.sequenceElement,
    )) {
      return false;
