...
abstract class $QuantityCopyWith<T> extends $DataTypeCopyWith<T> {
  @override
  T call({
    FhirString? id,
...
class _$QuantityCopyWithImpl<T> implements $QuantityCopyWith<T> {
  final Quantity _value;
  final T Function(Quantity) _then;
...
extension QuantityCopyWithExtension on Quantity {
