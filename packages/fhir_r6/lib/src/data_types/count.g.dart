...
abstract class $CountCopyWith<T> extends $QuantityCopyWith<T> {
  @override
  T call({
    FhirString? id,
...
class _$CountCopyWithImpl<T> implements $CountCopyWith<T> {
  final Count _value;
  final T Function(Count) _then;
...
extension CountCopyWithExtension on Count {
