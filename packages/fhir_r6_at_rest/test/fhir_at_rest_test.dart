...
void main() {
  group('FhirRequest - READ:', () {
    test('get patient', () {
      ...
      expect(
        ...
        'http://hapi.fhir.org/baseR6/Patient/12345?_format=json',
      );
    ...
    test('get patient with pretty', () {
      ...
      expect(
        request.buildUri().toString(),
        'http://hapi.fhir.org/baseR6/Patient/12345?_pretty=true&_format=json',
      );
    ...
    test('get patient with pretty and summary true', () {
      ...
      expect(
        request.buildUri().toString(),
        'http://hapi.fhir.org/baseR6/Patient/12345?_pretty=true&_summary=true&_format=json',
      );
    ...
    test('get patient with summary count', () {
      ...
      expect(
        request.buildUri().toString(),
        'http://hapi.fhir.org/baseR6/Patient/12345?_summary=count&_format=json',
      );
    ...
    test('get patient with pretty, only want to return name', () {
      ...
      expect(
        request.buildUri().toString(),
        'http://hapi.fhir.org/baseR6/Patient/1227442?_pretty=true&_elements=name&_format=json',
      );
    ...
    test('get patient with pretty, only want to return name and gender', () {
      ...
      expect(
        request.buildUri().toString(),
        'http://hapi.fhir.org/baseR6/Patient/1227442?_pretty=true&_elements=name,gender&_format=json',
      );
  ...
  group('FhirRequest - VREAD:', () {
    test('get patient version', () {
      ...
      expect(
        request.buildUri().toString(),
        'http://hapi.fhir.org/baseR6/Patient/12345/_history/6789?_format=json',
      );
    ...
    test('get patient version with pretty', () {
      ...
      expect(
        request.buildUri().toString(),
        'http://hapi.fhir.org/baseR6/Patient/12345/_history/6789?_pretty=true&_format=json',
      );
    ...
    test('get patient version with pretty and summary true', () {
      ...
      expect(
        request.buildUri().toString(),
        'http://hapi.fhir.org/baseR6/Patient/12345/_history/6789?_pretty=true&_summary=true&_format=json',
      );
    ...
    test('get patient version with summary count', () {
      ...
      expect(
        request.buildUri().toString(),
        'http://hapi.fhir.org/baseR6/Patient/12345/_history/6789?_summary=count&_format=json',
      );
  ...
  group('FhirRequest - TRANSACTION:', () {
    test('transaction with bundle', () {
      ...
      expect(
        request.buildUri().toString(),
        'http://hapi.fhir.org/baseR6?_format=json',
      );
  ...
  group('FhirRequest - HISTORY:', () {
    test('observation history by type and id', () {
      ...
      expect(
        request.buildUri().toString(),
        'http://hapi.fhir.org/baseR6/Observation/12345/_history?_format=json',
      );
    ...
    test('history for all resources', () {
      ...
      expect(
        request.buildUri().toString(),
        'http://hapi.fhir.org/baseR6/_history?_format=json',
      );
    ...
    test('history with parameters', () {
      ...
      expect(
        request.buildUri().toString(),
        'http://hapi.fhir.org/baseR6/Observation/12345/_history?_count=10&_since=2020-10-08T16:58:07.241117Z&_format=json',
      );
    ...
    test('history for everything with parameters', () {
      ...
      expect(
        request.buildUri().toString(),
        'http://hapi.fhir.org/baseR6/_history?_list=List/12345&_count=10&_since=2020-10-08&_format=json',
      );
  ...
  group('FhirRequest - UPDATE:', () {
    ...
    test('update patient with parameters', () {
      ...
      expect(
        request.buildUri().toString(),
        'http://hapi.fhir.org/baseR6/Patient/12345?_summary=true&_format=json',
      );
  ...
  group('FhirRequest - PATCH:', () {
    ...
    test('patch patient with parameters', () {
      ...
      expect(
        request.buildUri().toString(),
        'http://hapi.fhir.org/baseR6/Patient/12345?_elements=name&_format=json',
      );
  ...
  group('FhirRequest - DELETE:', () {
    ...
    test('delete patient with parameters', () {
      ...
      expect(
        request.buildUri().toString(),
        'http://hapi.fhir.org/baseR6/Patient/12345?_cascade=true&_format=json',
      );
  ...
  group('FhirRequest - CREATE:', () {
    test('create patient', () {
      ...
      expect(
        request.buildUri().toString(),
        'http://hapi.fhir.org/baseR6/Patient?_format=json',
      );
    ...
    test('create patient with parameters', () {
      ...
      expect(
        request.buildUri().toString(),
        'http://hapi.fhir.org/baseR6/Patient?_pretty=true&_format=json',
      );
  ...
  group('FhirRequest - CAPABILITIES:', () {
    test('capabilities without parameters', () {
      ...
      expect(
        request.buildUri().toString(),
        'http://hapi.fhir.org/baseR6/metadata?_format=json',
      );
    ...
    test('capabilities with mode normative', () {
      ...
      expect(
        request.buildUri().toString(),
        'http://hapi.fhir.org/baseR6/metadata?_pretty=true&mode=normative&_format=json',
      );
  ...
  group('FhirRequest - OPERATION:', () {
    test(r'$everything operation', () {
      ...
      expect(
        request.buildUri().toString(),
        r'http://hapi.fhir.org/baseR6/$everything?start=2020-01-01&end=2020-08-01&_format=json',
      );
    ...
    test(r'$everything operation for Patient 744742', () {
      ...
      expect(
        request.buildUri().toString(),
        r'http://hapi.fhir.org/baseR6/Patient/744742/$everything?start=2020-01-01&end=2020-08-01&_format=json',
      );
  ...
  group('FhirRequest - BATCH:', () {
    ...
    test('batch with parameters', () {
      ...
      expect(
        request.buildUri().toString(),
        'http://hapi.fhir.org/baseR6?_summary=true&_format=json',
      );
  ...
  group('FhirRequest - SEARCH:', () {
    ...
    test('search patient by name and gender', () {
      ...
      expect(
        request.buildUri().toString(),
        'http://hapi.fhir.org/baseR6/Patient?name=John&gender=male&_format=json',
      );
    ...
    test('search patient using POST with a complex query', () {
      ...
      expect(
        request.buildUri().toString(),
        'http://hapi.fhir.org/baseR6/Patient/_search?_format=json',
      );
    ...
    test('search patient with missing gender', () {
      ...
      expect(
        request.buildUri().toString(),
        'http://hapi.fhir.org/baseR6/Patient?gender:missing=true&_format=json',
      );
    ...
    test('search all resources for a specific type', () {
      ...
      expect(
        request.buildUri().toString(),
        'http://hapi.fhir.org/baseR6?_type=Patient&name=John&_format=json',
      );
  ...
  group('FhirRequest - OPERATION:', () {
    test('operation without parameters', () {
      ...
      expect(
        request.buildUri().toString(),
        r'http://hapi.fhir.org/baseR6/$everything?_format=json',
      );
    ...
    test('operation for a specific resource type', () {
      ...
      expect(
        request.buildUri().toString(),
        r'http://hapi.fhir.org/baseR6/Patient/$everything?_format=json',
      );
    ...
    test('operation for a specific resource instance', () {
      ...
      expect(
        request.buildUri().toString(),
        r'http://hapi.fhir.org/baseR6/Patient/12345/$everything?_format=json',
      );
