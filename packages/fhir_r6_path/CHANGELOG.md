...
- Rebuilt as a thin FHIR R6 binding over the model-independent [fhirpath](https://pub.dev/packages/fhirpath) engine (fhirpath ^0.6.0): version-specific model resolution lives here, the engine logic in fhirpath
