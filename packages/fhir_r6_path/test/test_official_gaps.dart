...
Future<void> testOfficialGaps() async {
  ...
  group('official-testInheritance', () {
    ...
    // but the Java reference only enforces that rule for R5+ (its R6
    // engine sets doNotEnforceAsSingletonRule); our R6 binding matches the
    // reference's R6 leniency, so there is no error to assert.
