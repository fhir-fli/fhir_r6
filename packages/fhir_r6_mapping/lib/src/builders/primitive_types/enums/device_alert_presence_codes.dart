...
class DeviceAlertPresenceCodesBuilder extends FhirCodeEnumBuilder {
  ...
  factory DeviceAlertPresenceCodesBuilder.fromJson(
    ...
    final known = _known(DeviceAlertPresenceCodesBuilderEnum.fromString(value));
    return DeviceAlertPresenceCodesBuilder._(
      valueString: value,
  ...
  static DeviceAlertPresenceCodesBuilder? _known(
      DeviceAlertPresenceCodesBuilderEnum? valueEnum) {
