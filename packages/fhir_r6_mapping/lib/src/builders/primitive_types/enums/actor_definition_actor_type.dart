...
class ActorDefinitionActorTypeBuilder extends FhirCodeEnumBuilder {
  ...
  factory ActorDefinitionActorTypeBuilder.fromJson(
    ...
    final known = _known(ActorDefinitionActorTypeBuilderEnum.fromString(value));
    return ActorDefinitionActorTypeBuilder._(
      valueString: value,
  ...
  static ActorDefinitionActorTypeBuilder? _known(
      ActorDefinitionActorTypeBuilderEnum? valueEnum) {
