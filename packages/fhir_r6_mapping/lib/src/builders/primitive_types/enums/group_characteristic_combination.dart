...
class GroupCharacteristicCombinationBuilder extends FhirCodeEnumBuilder {
  ...
  factory GroupCharacteristicCombinationBuilder.fromJson(
    ...
    final known =
        _known(GroupCharacteristicCombinationBuilderEnum.fromString(value));
    return GroupCharacteristicCombinationBuilder._(
      valueString: value,
  ...
  static GroupCharacteristicCombinationBuilder? _known(
      GroupCharacteristicCombinationBuilderEnum? valueEnum) {
