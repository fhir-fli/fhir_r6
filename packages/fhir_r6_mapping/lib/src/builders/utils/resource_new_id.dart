...
ResourceBuilder resourceWithNewId(ResourceBuilder resource) {
  ...
  switch (resource.resourceType) {
    ...
    case R6ResourceType.ClinicalAssessment:
      return (resource as ClinicalAssessmentBuilder).copyWith(id: newId);
    ...
    case R6ResourceType.DeviceAlert:
      return (resource as DeviceAlertBuilder).copyWith(id: newId);
    ...
    case R6ResourceType.InsuranceProduct:
      return (resource as InsuranceProductBuilder).copyWith(id: newId);
    ...
    case R6ResourceType.MolecularDefinition:
      return (resource as MolecularDefinitionBuilder).copyWith(id: newId);
    ...
    case R6ResourceType.PersonalRelationship:
      return (resource as PersonalRelationshipBuilder).copyWith(id: newId);
