...
import 'package:fhir_r6/fhir_r6.dart'
    show R6ResourceType, Slot, yamlMapToJson, yamlToJson;
...
class SlotBuilder extends DomainResourceBuilder {
      ...
      appointmentType: (json['appointmentType'] as List<dynamic>?)
          ?.map<CodeableConceptBuilder>(
            (v) => CodeableConceptBuilder.fromJson(
              {
                ...v as Map<String, dynamic>,
                'objectPath': '$objectPath.appointmentType',
              },
            ),
          )
          .toList(),
  ...
  /// service type).
  List<CodeableConceptBuilder>? appointmentType;
  ...
  void createProperty(String propertyName) {
    switch (propertyName) {
      ...
      case 'appointmentType':
        {
          appointmentType = <CodeableConceptBuilder>[];
          return;
        }
      case 'schedule':
        {
