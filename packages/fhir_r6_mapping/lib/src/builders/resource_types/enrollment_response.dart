...
class EnrollmentResponseBuilder extends DomainResourceBuilder {
  ...
  factory EnrollmentResponseBuilder.fromJson(
    ...
    return EnrollmentResponseBuilder(
      ...
      outcome: JsonParser.parsePrimitive<EnrollmentOutcomeBuilder>(
        json,
        'outcome',
        EnrollmentOutcomeBuilder.fromJson,
        '$objectPath.outcome',
      ),
  ...
  EnrollmentOutcomeBuilder? outcome;
  ...
  void setChildByName(String childName, dynamic child) {
    ...
    switch (childName) {
      ...
      case 'outcome':
        {
          if (child is EnrollmentOutcomeBuilder) {
            outcome = child;
            return;
          } else if (child is PrimitiveTypeBuilder) {
            // Try to convert from one primitive type to another
            try {
              ...
              // For enums, try to create directly from the string value
              try {
                final converted = EnrollmentOutcomeBuilder(stringValue);
                outcome = converted;
                return;
              } catch (e) {
                // Continue if enum creation fails
  ...
  void createProperty(String propertyName) {
    switch (propertyName) {
      ...
      case 'outcome':
        {
          outcome = EnrollmentOutcomeBuilder.empty();
          return;
        }
      case 'disposition':
        {
