...
/// is called "ClinicalAssessment" rather than "ClinicalAssessment" to
/// avoid confusion with the recording of assessment tools such as Apgar
/// score.
class ClinicalAssessmentBuilder extends DomainResourceBuilder {
  ...
  ClinicalAssessmentBuilder({
    ...
    this.subject,
    this.encounter,
    EffectiveXClinicalAssessmentBuilder? effectiveX,
    ...
    this.note,
        ...
        super(
          objectPath: 'ClinicalAssessment',
          resourceType: R6ResourceType.ClinicalAssessment,
        );

  /// An empty constructor for partial usage.
  /// For Builder classes, no fields are required
  factory ClinicalAssessmentBuilder.empty() => ClinicalAssessmentBuilder(
        status: EventStatusBuilder.values.first,
        subject: ReferenceBuilder.empty(),
      );

  /// Factory constructor that accepts [Map<String, dynamic>] as an argument
  factory ClinicalAssessmentBuilder.fromJson(
    Map<String, dynamic> json,
  ) {
    const objectPath = 'ClinicalAssessment';
    return ClinicalAssessmentBuilder(
      ...
      effectiveX:
          JsonParser.parsePolymorphic<EffectiveXClinicalAssessmentBuilder>(
        json,
        {
      ...
      finding: (json['finding'] as List<dynamic>?)
          ?.map<ClinicalAssessmentFindingBuilder>(
            (v) => ClinicalAssessmentFindingBuilder.fromJson(
              {
                ...v as Map<String, dynamic>,
  ...
  /// Deserialize [ClinicalAssessmentBuilder]
  /// from a [String] or [YamlMap] object
  factory ClinicalAssessmentBuilder.fromYaml(
    dynamic yaml,
  ) {
    if (yaml is String) {
      return ClinicalAssessmentBuilder.fromJson(
        yamlToJson(yaml),
      );
  ...
  factory ClinicalAssessmentBuilder.fromJsonString(
    String source,
  ) {
    final dynamic json = jsonDecode(source);
    if (json is Map<String, dynamic>) {
      return ClinicalAssessmentBuilder.fromJson(json);
    } else {
  ...
  @override
  String get fhirType => 'ClinicalAssessment';

  /// [identifier]
  /// Business identifiers assigned to this clinical assessment by the
  ...
  /// [encounter]
  /// The Encounter during which this ClinicalAssessment was created or to
  ...
  List<ClinicalAssessmentFindingBuilder>? finding;
  ...
  /// [supportingInfo]
  /// Information supporting the clinical assessment, which can contain
  /// investigation results.
  List<ReferenceBuilder>? supportingInfo;

  /// [note]
  /// Commentary about the assessment, typically recorded after the
  /// assessment itself was made, though supplemental notes by the original
  /// author could also appear.
  List<AnnotationBuilder>? note;

  /// Converts a [ClinicalAssessmentBuilder]
  /// to [ClinicalAssessment]
  @override
  ClinicalAssessment build() => ClinicalAssessment.fromJson(toJson());
  ...
  void setChildByName(String childName, dynamic child) {
    ...
    switch (childName) {
      ...
      case 'effectiveX':
        {
          if (child is EffectiveXClinicalAssessmentBuilder) {
            effectiveX = child;
            return;
          } else {
      ...
      case 'finding':
        {
          if (child is List<ClinicalAssessmentFindingBuilder>) {
            // Replace or create new list
            finding = child;
            return;
          } else if (child is ClinicalAssessmentFindingBuilder) {
            // Add single element to existing list or create new list
            finding = [
              ...(finding ?? []),
              child,
  ...
  List<String> typeByElementName(String fieldName) {
    switch (fieldName) {
      ...
      case 'finding':
        return ['ClinicalAssessmentFindingBuilder'];
      case 'prognosisCodeableConcept':
        return ['CodeableConceptBuilder'];
      case 'prognosisReference':
        return ['ReferenceBuilder'];
  ...
  /// Creates a new [ClinicalAssessmentBuilder]
  ...
  void createProperty(String propertyName) {
    switch (propertyName) {
      ...
      case 'finding':
        {
          finding = <ClinicalAssessmentFindingBuilder>[];
          return;
        }
      case 'prognosisCodeableConcept':
        {
  ...
  @override
  ClinicalAssessmentBuilder clone() => throw UnimplementedError();
  @override
  ClinicalAssessmentBuilder copyWith({
    ...
    final newResult = ClinicalAssessmentBuilder(
      id: id ?? this.id,
      meta: meta ?? this.meta,
  ...
  bool equalsDeep(FhirBaseBuilder? o) {
    if (o is! ClinicalAssessmentBuilder) {
      return false;
    }
    ...
    if (!listEquals<ClinicalAssessmentFindingBuilder>(
      finding,
      o.finding,
    )) {
      return false;
...
/// [ClinicalAssessmentFindingBuilder]
/// Specific findings or diagnoses that were considered likely or relevant
/// to ongoing treatment.
class ClinicalAssessmentFindingBuilder extends BackboneElementBuilder {
  /// Primary constructor for
  /// [ClinicalAssessmentFindingBuilder]
  ...
  ClinicalAssessmentFindingBuilder({
    ...
    super.disallowExtensions,
          ...
          objectPath: 'ClinicalAssessment.finding',
        );

  /// An empty constructor for partial usage.
  /// For Builder classes, no fields are required
  factory ClinicalAssessmentFindingBuilder.empty() =>
      ClinicalAssessmentFindingBuilder();

  /// Factory constructor that accepts [Map<String, dynamic>] as an argument
  factory ClinicalAssessmentFindingBuilder.fromJson(
    Map<String, dynamic> json,
  ) {
    const objectPath = 'ClinicalAssessment.finding';
    return ClinicalAssessmentFindingBuilder(
      id: JsonParser.parsePrimitive<FhirStringBuilder>(
        json,
        'id',
  ...
  /// Deserialize [ClinicalAssessmentFindingBuilder]
  /// from a [String] or [YamlMap] object
  factory ClinicalAssessmentFindingBuilder.fromYaml(
    dynamic yaml,
  ) {
    if (yaml is String) {
      return ClinicalAssessmentFindingBuilder.fromJson(
        yamlToJson(yaml),
      );
    } else if (yaml is YamlMap) {
      return ClinicalAssessmentFindingBuilder.fromJson(
  ...
  /// Convenience method to avoid the json Encoding/Decoding normally required
  /// to get data from a [String]
  factory ClinicalAssessmentFindingBuilder.fromJsonString(
    String source,
  ) {
    final dynamic json = jsonDecode(source);
    if (json is Map<String, dynamic>) {
      return ClinicalAssessmentFindingBuilder.fromJson(json);
    } else {
      throw FormatException('FormatException: You passed $json '
          'This does not properly decode to a Map<String, dynamic>.');
    }
  ...
  @override
  String get fhirType => 'ClinicalAssessmentFinding';
  ...
  /// Converts a [ClinicalAssessmentFindingBuilder]
  /// to [ClinicalAssessmentFinding]
  @override
  ClinicalAssessmentFinding build() =>
      ClinicalAssessmentFinding.fromJson(toJson());
  ...
  /// Creates a new [ClinicalAssessmentFindingBuilder]
  ///  with a chosen field set to an empty object.
  @override
  void createProperty(String propertyName) {
    switch (propertyName) {
  ...
  @override
  ClinicalAssessmentFindingBuilder clone() => throw UnimplementedError();
  @override
  ClinicalAssessmentFindingBuilder copyWith({
    FhirStringBuilder? id,
    List<FhirExtensionBuilder>? extension_,
    List<FhirExtensionBuilder>? modifierExtension,
    CodeableReferenceBuilder? item,
    ...
    final newResult = ClinicalAssessmentFindingBuilder(
      id: id ?? this.id,
      extension_: extension_ ?? this.extension_,
      modifierExtension: modifierExtension ?? this.modifierExtension,
      item: item ?? this.item,
  ...
  @override
  bool equalsDeep(FhirBaseBuilder? o) {
    if (o is! ClinicalAssessmentFindingBuilder) {
      return false;
    }
    if (identical(this, o)) return true;
    if (runtimeType != o.runtimeType) return false;
