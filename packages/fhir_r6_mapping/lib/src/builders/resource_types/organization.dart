...
class OrganizationBuilder extends DomainResourceBuilder {
  ...
  factory OrganizationBuilder.fromJson(
    ...
    return OrganizationBuilder(
      ...
      qualification: (json['qualification'] as List<dynamic>?)
          ?.map<OrganizationQualificationBuilder>(
            (v) => OrganizationQualificationBuilder.fromJson(
              {
                ...v as Map<String, dynamic>,
  ...
  /// to an organization.
  List<OrganizationQualificationBuilder>? qualification;
  ...
  void setChildByName(String childName, dynamic child) {
    ...
    switch (childName) {
      ...
      case 'qualification':
        {
          if (child is List<OrganizationQualificationBuilder>) {
            // Replace or create new list
            qualification = child;
            return;
          } else if (child is OrganizationQualificationBuilder) {
            // Add single element to existing list or create new list
            qualification = [
              ...(qualification ?? []),
              child,
  ...
  void createProperty(String propertyName) {
    switch (propertyName) {
      ...
      case 'qualification':
        {
          qualification = <OrganizationQualificationBuilder>[];
          return;
        }
      default:
  ...
  bool equalsDeep(FhirBaseBuilder? o) {
    ...
    if (!listEquals<OrganizationQualificationBuilder>(
      qualification,
      o.qualification,
    )) {
      return false;
...
/// services issued by a certifying body (such as the US Joint Commission)
/// to an organization.
class OrganizationQualificationBuilder extends BackboneElementBuilder {
  /// Primary constructor for
  /// [OrganizationQualificationBuilder]
  ...
  OrganizationQualificationBuilder({
    ...
    super.disallowExtensions,
          ...
          objectPath: 'Organization.qualification',
        );

  /// An empty constructor for partial usage.
  /// For Builder classes, no fields are required
  factory OrganizationQualificationBuilder.empty() =>
      OrganizationQualificationBuilder(
        code: CodeableConceptBuilder.empty(),
      );

  /// Factory constructor that accepts [Map<String, dynamic>] as an argument
  factory OrganizationQualificationBuilder.fromJson(
    Map<String, dynamic> json,
  ) {
    const objectPath = 'Organization.qualification';
    return OrganizationQualificationBuilder(
      id: JsonParser.parsePrimitive<FhirStringBuilder>(
        json,
        'id',
  ...
  /// Deserialize [OrganizationQualificationBuilder]
  /// from a [String] or [YamlMap] object
  factory OrganizationQualificationBuilder.fromYaml(
    dynamic yaml,
  ) {
    if (yaml is String) {
      return OrganizationQualificationBuilder.fromJson(
        yamlToJson(yaml),
      );
    } else if (yaml is YamlMap) {
      return OrganizationQualificationBuilder.fromJson(
  ...
  /// Convenience method to avoid the json Encoding/Decoding normally required
  /// to get data from a [String]
  factory OrganizationQualificationBuilder.fromJsonString(
    String source,
  ) {
    final dynamic json = jsonDecode(source);
    if (json is Map<String, dynamic>) {
      return OrganizationQualificationBuilder.fromJson(json);
    } else {
      throw FormatException('FormatException: You passed $json '
          'This does not properly decode to a Map<String, dynamic>.');
    }
  ...
  /// Converts a [OrganizationQualificationBuilder]
  /// to [OrganizationQualification]
  @override
  OrganizationQualification build() =>
      OrganizationQualification.fromJson(toJson());
  ...
  /// Creates a new [OrganizationQualificationBuilder]
  ///  with a chosen field set to an empty object.
  @override
  void createProperty(String propertyName) {
    switch (propertyName) {
  ...
  @override
  OrganizationQualificationBuilder clone() => throw UnimplementedError();
  @override
  OrganizationQualificationBuilder copyWith({
    FhirStringBuilder? id,
    List<FhirExtensionBuilder>? extension_,
    List<FhirExtensionBuilder>? modifierExtension,
    List<IdentifierBuilder>? identifier,
    ...
    final newResult = OrganizationQualificationBuilder(
      id: id ?? this.id,
      extension_: extension_ ?? this.extension_,
      modifierExtension: modifierExtension ?? this.modifierExtension,
      identifier: identifier ?? this.identifier,
  ...
  @override
  bool equalsDeep(FhirBaseBuilder? o) {
    if (o is! OrganizationQualificationBuilder) {
      return false;
    }
    if (identical(this, o)) return true;
    if (runtimeType != o.runtimeType) return false;
