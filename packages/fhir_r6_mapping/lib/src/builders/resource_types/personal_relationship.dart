...
import 'package:fhir_r6/fhir_r6.dart'
    show PersonalRelationship, R6ResourceType, yamlMapToJson, yamlToJson;
import 'package:fhir_r6_mapping/fhir_r6_mapping.dart';
import 'package:yaml/yaml.dart';

/// [PersonalRelationshipBuilder]
...
/// relationship itself.
class PersonalRelationshipBuilder extends DomainResourceBuilder {
  ...
  PersonalRelationshipBuilder({
    ...
    this.group,
          ...
          objectPath: 'PersonalRelationship',
          resourceType: R6ResourceType.PersonalRelationship,
        );

  /// An empty constructor for partial usage.
  /// For Builder classes, no fields are required
  factory PersonalRelationshipBuilder.empty() => PersonalRelationshipBuilder(
  ...
  factory PersonalRelationshipBuilder.fromJson(
    Map<String, dynamic> json,
  ) {
    const objectPath = 'PersonalRelationship';
    return PersonalRelationshipBuilder(
      ...
      period: (json['period'] as List<dynamic>?)
          ...
          .toList(),
      confidence: JsonParser.parseObject<CodeableConceptBuilder>(
        json,
        'confidence',
        CodeableConceptBuilder.fromJson,
        '$objectPath.confidence',
      ),
  ...
  /// Deserialize [PersonalRelationshipBuilder]
  /// from a [String] or [YamlMap] object
  factory PersonalRelationshipBuilder.fromYaml(
    dynamic yaml,
  ) {
    if (yaml is String) {
      return PersonalRelationshipBuilder.fromJson(
        yamlToJson(yaml),
      );
  ...
  factory PersonalRelationshipBuilder.fromJsonString(
    String source,
  ) {
    final dynamic json = jsonDecode(source);
    if (json is Map<String, dynamic>) {
      return PersonalRelationshipBuilder.fromJson(json);
    } else {
  ...
  /// relationship.
  CodeableConceptBuilder? confidence;
  ...
  List<ReferenceBuilder>? group;

  /// Converts a [PersonalRelationshipBuilder]
  /// to [PersonalRelationship]
  @override
  PersonalRelationship build() => PersonalRelationship.fromJson(toJson());
  ...
  /// Creates a new [PersonalRelationshipBuilder]
  ...
  void createProperty(String propertyName) {
    switch (propertyName) {
      ...
      case 'confidence':
        {
          confidence = CodeableConceptBuilder.empty();
          return;
        }
      case 'asserter':
        {
  ...
  @override
  PersonalRelationshipBuilder clone() => throw UnimplementedError();
  @override
  PersonalRelationshipBuilder copyWith({
    ...
    final newResult = PersonalRelationshipBuilder(
      id: id ?? this.id,
      meta: meta ?? this.meta,
  ...
  bool equalsDeep(FhirBaseBuilder? o) {
    if (o is! PersonalRelationshipBuilder) {
      return false;
    }
